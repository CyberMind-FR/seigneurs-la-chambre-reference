...
7 illustration(s) à régénérer par prompt ; 15 fragment(s) par une autre voie (voir tableau final).

## P07-hero_captioned

- Fichier attendu : `assets/hd/page-07/hero_captioned.png`
...
- Fichier attendu : `assets/hd/page-07/valley_panorama.png`
- Référence à joindre : `reference/page-07/valley_panorama.png` (crop canonique 503×186 px)
- Ratio L/H : 2.7043 — canevas natif conseillé : landscape 1536×1024 → recadrage centré 1536×567 px
- Gate 300.0 ppi (continuous_tone) — couverture au canevas natif : A5 ✔(≥813 px) A4 ✔(≥1149 px) A2 ✘(≥1625 px) A1 ✘(≥2298 px)
- Sans légende raster

```text
Redessine l'illustration jointe en haute définition, en conservant exactement le même sujet, le même point de vue, le même cadrage et la même composition (mêmes positions des éléments principaux). Ne rajoute aucun élément historique ou architectural absent de la référence.
Sujet : Panorama de vallée alpine avec rivière, village et clocher, montagnes.
Style : Illustration à l'encre et à l'aquarelle, style carnet de voyage / gravure aquarellée : traits d'encre fins brun sépia, lavis d'aquarelle doux et lumineux, palette chaude et naturelle (ocre, beige parchemin, gris pierre, vert olive et vert mousse, bleus pâles pour les ciels et les sommets enneigés), fond de papier crème uni (#FFFDF7) sans texture marquée, lumière diffuse, pas de contours noirs épais, pas de rendu photographique ni 3D.
À ne pas reproduire : rien à retirer. Aucun texte, lettre, chiffre, signature, filigrane, logo, flèche, cartouche, cadre, bordure ornementale, bulle ou étiquette. Aucun personnage ou objet moderne (véhicule, câble, panneau) sauf indication contraire. Pas de texture de papier vieilli ni de taches. Pas de bordure ni de vignettage : le dessin s'estompe naturellement dans le papier crème.
Format : paysage (plus large que haut), ratio largeur/hauteur ≈ 2.70. Le sujet doit rester entièrement dans le cadre avec une légère marge de papier crème uni sur les bords (l'image sera recadrée au centre à ce ratio exact, sans agrandissement). Produis la plus grande taille disponible (au minimum 1536×1024 px).
```

## P07-vassal_scene_captioned

- Fichier attendu : `assets/hd/page-07/vassal_scene_captioned.png`
...
## P07-defensive_box_captioned

- Fichier attendu : `assets/hd/page-07/defensive_box_captioned.png`
...
## P07-battle_scene_captioned

- Fichier attendu : `assets/hd/page-07/battle_scene_captioned.png`
...
## P07-localization_vignette

- Fichier attendu : `assets/hd/page-07/localization_vignette.png`
- Référence à joindre : `reference/page-07/localization_vignette.png` (crop canonique 235×106 px)
- Ratio L/H : 2.2170 — canevas natif conseillé : landscape 1536×1024 → recadrage centré 1536×692 px
- Gate 300.0 ppi (continuous_tone) — couverture au canevas natif : A5 ✔(≥380 px) A4 ✔(≥537 px) A2 ✔(≥759 px) A1 ✔(≥1074 px)
- Sans légende raster

```text
Redessine l'illustration jointe en haute définition, en conservant exactement le même sujet, le même point de vue, le même cadrage et la même composition (mêmes positions des éléments principaux). Ne rajoute aucun élément historique ou architectural absent de la référence.
Sujet : Tour ruinée sur une colline, montagnes enneigées.
Style : Illustration à l'encre et à l'aquarelle, style carnet de voyage / gravure aquarellée : traits d'encre fins brun sépia, lavis d'aquarelle doux et lumineux, palette chaude et naturelle (ocre, beige parchemin, gris pierre, vert olive et vert mousse, bleus pâles pour les ciels et les sommets enneigés), fond de papier crème uni (#FFFDF7) sans texture marquée, lumière diffuse, pas de contours noirs épais, pas de rendu photographique ni 3D.
À ne pas reproduire : rien à retirer. Aucun texte, lettre, chiffre, signature, filigrane, logo, flèche, cartouche, cadre, bordure ornementale, bulle ou étiquette. Aucun personnage ou objet moderne (véhicule, câble, panneau) sauf indication contraire. Pas de texture de papier vieilli ni de taches. Pas de bordure ni de vignettage : le dessin s'estompe naturellement dans le papier crème.
...
- Fichier attendu : `assets/hd/page-07/bottom_vignette.png`
- Référence à joindre : `reference/page-07/bottom_vignette.png` (crop canonique 390×150 px)
- Ratio L/H : 2.6000 — canevas natif conseillé : landscape 1536×1024 → recadrage centré 1536×590 px
- Gate 300.0 ppi (continuous_tone) — couverture au canevas natif : A5 ✔(≥630 px) A4 ✔(≥891 px) A2 ✔(≥1260 px) A1 ✘(≥1782 px)
- Sans légende raster

```text
Redessine l'illustration jointe en haute définition, en conservant exactement le même sujet, le même point de vue, le même cadrage et la même composition (mêmes positions des éléments principaux). Ne rajoute aucun élément historique ou architectural absent de la référence.
Sujet : Tour ruinée sur une butte avec arbres, montagnes.
Style : Illustration à l'encre et à l'aquarelle, style carnet de voyage / gravure aquarellée : traits d'encre fins brun sépia, lavis d'aquarelle doux et lumineux, palette chaude et naturelle (ocre, beige parchemin, gris pierre, vert olive et vert mousse, bleus pâles pour les ciels et les sommets enneigés), fond de papier crème uni (#FFFDF7) sans texture marquée, lumière diffuse, pas de contours noirs épais, pas de rendu photographique ni 3D.
À ne pas reproduire : résidu du titre « MONUMENT HISTORIQUE »; résidu de sceau à droite. Aucun texte, lettre, chiffre, signature, filigrane, logo, flèche, cartouche, cadre, bordure ornementale, bulle ou étiquette. Aucun personnage ou objet moderne (véhicule, câble, panneau) sauf indication contraire. Pas de texture de papier vieilli ni de taches. Pas de bordure ni de vignettage : le dessin s'estompe naturellement dans le papier crème.
Format : paysage (plus large que haut), ratio largeur/hauteur ≈ 2.60. Le sujet doit rester entièrement dans le cadre avec une légère marge de papier crème uni sur les bords (l'image sera recadrée au centre à ce ratio exact, sans agrandissement). Produis la plus grande taille disponible (au minimum 1536×1024 px).
```
...
| `compass_rose_top_right` | `ornament` | `vector_svg` |
